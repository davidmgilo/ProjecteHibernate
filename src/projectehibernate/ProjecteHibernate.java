...
//    }
        ...
        ClasseDAO portDAO = new ClasseDAO(Port.class,sesion);
...
//Creem tres instàncies de Contacte 
        ...
        contacte3.add5_treballen(cap3);
        
        Port port1 = new Port("Port 1",100);
        Port port2 = new Port("Port 2",140);
        Port port3 = new Port("Port 3",90);
...
//Guardem les tres instàncies, i copiem l'id del contacte1 per usar-lo posteriorment 
        ...
        portDAO.guarda(port1);
        portDAO.guarda(port2);
        portDAO.guarda(port3);

//        port3.add4_atraquen(contacte2);
//        portDAO.actualitza(port3);
        //Només cal guardar el 'pare'
        contacte2.add6_circula(port3);
        vaixellsDAO.actualitza(contacte2);
        
        cap3.set4_vaixell(contacte3);
        pescadorsDAO.actualitza(cap3);
